...
export default {
  ...
  navSearch: 'Search',
  searchPlaceholder: 'Search programmes & benefits',
  searchAriaLabel: 'Search programmes and benefits',
  similarProgrammes: 'Similar programmes',
  ...
  footCompare: 'Compare',
  footFunders: 'Funders A–Z',
  footLearn: 'Learn',
  relatedReading: 'Related reading',
  footSource: 'Source on GitHub',
  footScams: 'Spot a grant scam',
  footAccessibility: 'Accessibility',
  footChangelog: "What's new",
  ...
  statScopeNote: (n) => `of ${n} company grants`,
  statAsOf: (d) => `Status as of ${d}`,
  ...
  trust1B: "Every programme links back to the funder — sourced to the funder's own page, with the date we last read it. Records we have not re-checked say so.",
  ...
  trust3T: 'Your answers stay in your browser',
  trust3B: 'The free check runs entirely in your browser and your answers are never sent to us. We count anonymous, cookieless visits, nothing more.',
  ...
  homeDesc: (n, c) =>
    `A free, anonymous check against ${n} sourced government and institutional support programmes in ${c} jurisdictions. See how much you could be owed in ninety seconds.`,
  ...
  trustVerifiedOn: (date) => `Verified on ${date}`,
  trustSourceHost: (host) => `Source: ${host}`,
  trustSourceHomepage: "Source: funder's homepage — the programme page was not found",
  ...
  acctPaused: (date) => `Paused until ${date}. Resume any time to unlock your programmes again.`,
  acctPausedOpen: "Paused. Resume any time to unlock your programmes again.",
  acctPauseCta: 'Pause subscription',
  acctResumeCta: 'Resume subscription',
  acctPauseHint: 'Pause for a few months — no charge while paused, and everything unlocks the moment you resume.',
  acctPauseMonthsLabel: (n) => `${n} month${n === 1 ? '' : 's'}`,
  acctQuotaT: 'AI generations this month',
  acctQuotaLine: (left, allowance) => `${left} of ${allowance} left`,
  acctQuotaCredits: (n) => `${n} more, from your packs`,
  acctQuotaNone: 'No monthly allowance on this plan. The document checklist and application pack stay free and unlimited.',
  ...
  privSecs: [
    ...
    [`The document checklist and vault`, `The free checklist records the NAME of a document you have gathered — "proof of income" — and the date, so a later claim that wants the same paper can tick it off for you. Signed-in subscribers can also keep the file itself in the document vault: it is encrypted on your own device before anything is uploaded, under a key derived from your own passphrase. What reaches our server is ciphertext, a document type, a size and two dates — never a filename, a note, or anything we can read. See the Trust, privacy & AI page for the full picture, including the one AI feature and what our analytics beacon sends.`],
  ...
  methCompH: `Company grants`,
  methCompP: (n, j) =>
    `The figures above cover the household side only. The company side of the catalogue holds a further ${n} startup and company grants across ${j} jurisdictions — including EU-level and global programmes — sourced and dated the same way. Closed schemes are shown with their reopen dates rather than removed, and status is recomputed on every build.`,
  methOpenH: `The data is yours`,
  methOpenP1: `The full dataset is open.`,
  methOpenApi: `Use the JSON API, or build an MCP server on the published tool schemas`,
  ...
  methSrcL: [
    ...
    `Closed schemes are not hidden. They are shown with their reopen dates, and status is recomputed every day.`,
  ...
  priceTrialLine: '14-day free trial',
  priceStudentLine: 'Students and nonprofits: ask for a discount.',
